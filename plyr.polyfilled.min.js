"object" == typeof navigator && function (e, t) {
    ...
    const S = e => null != e ? e.constructor : null,
        ...
        N = e => Array.isArray(e),
        x = e => C(e, NodeList),
        L = e => A(e) || (P(e) || N(e) || x(e)) && !e.length || E(e) && !Object.keys(e).length;
    var I = A,
        _ = E,
        O = e => S(e) === Number && !Number.isNaN(e),
        $ = P,
        j = e => S(e) === Boolean,
        R = M,
        D = N,
        ...
        F = e => C(e, Event),
        V = e => C(e, KeyboardEvent),
        U = e => C(e, TextTrack) || !A(e) && P(e.kind),
        B = e => C(e, Promise) && M(e.then),
        z = e => {
    ...
    function J(e = {}, ...t) {
        ...
        const i = t.shift();
        return _(i) ? (Object.keys(i).forEach((t => {
            _(i[t]) ? (Object.keys(e).includes(t) || Object.assign(e, {
                [t]: {}
    ...
    function ee(e, t, i) {
        ...
        return _(t) && Z(s, t), $(i) && (s.innerText = i), s
    }
    ...
    function ae(e, t) {
        ...
        return e.split(",").forEach((e => {
            ...
            switch (t.charAt(0)) {
                case ".":
                    $(s.class) ? i.class = `${s.class} ${n}` : i.class = n;
                    break;
                case "#":
                    i.id = t.replace("#", "");
                    break;
    ...
    const pe = {
        ...
        me = {
            ...
            check(e, t) {
                const i = me[e] || "html5" !== t;
                return {
                    api: i,
                    ui: i && me.rangeInput
                }
            },
            pip: !(G.isIPhone || !R(ee("video").webkitSetPresentationMode) && (!document.pictureInPictureEnabled || ee("video").disablePictureInPicture)),
    ...
    function fe(e, t, i, s = !1, n = !0, a = !1) {
        if (!e || !("addEventListener" in e) || W(t) || !R(i)) return;
        const r = t.split(" ");
        let o = a;
        ge && (o = {
            passive: n,
    ...
    function Me(e) {
        if (!(D(e) || $(e) && e.includes(":"))) return !1;
        return (D(e) ? e : e.split(":")).map(Number).every(O)
    }

    function Ne(e) {
        if (!D(e) || !e.every(O)) return null;
    ...
    function Le(e) {
        ...
        if (Ee(`aspect-ratio: ${s}/${n}`) ? t.style.aspectRatio = `${s}/${n}` : t.style.paddingBottom = `${a}%`, this.isVimeo && !this.config.vimeo.premium && this.supported.ui) {
    ...
    const _e = {
        ...
        setup() {
            if (!this.isHTML5) return;
            const e = this;
            e.options.speed = e.config.speed.options, W(this.config.ratio) || Le.call(e), Object.defineProperty(e.media, "quality", {
                get() {
        ...
        cancelRequests() {
            this.isHTML5 && (ie(_e.getSources.call(this)), this.media.setAttribute("src", this.config.blankVideo), this.media.load(), this.debug.log("Cancelled network requests"))
        }
    };
    ...
    function Re(e = "") {
        ...
        return t = function (e = "") {
            let t = e.toString();
            return t = $e(t, "-", " "), t = $e(t, "_", " "), t = je(t), $e(t, " ", "")
    ...
    const We = {
        getIconUrl() {
            const e = new URL(this.config.iconUrl, window.location),
                ...
                i = e.host !== t || G.isIE && !window.svg4everybody;
            return {
        ...
        createButton(e, t) {
            ...
            }))) : (a.appendChild(We.createIcon.call(this, n.icon)), a.appendChild(We.createLabel.call(this, n.label))), J(i, ae(this.config.selectors.buttons[s], i)), Z(a, i), "play" === s ? (D(this.elements.buttons[s]) || (this.elements.buttons[s] = []), this.elements.buttons[s].push(a)) : this.elements.buttons[s] = a, a
        },
        createRange(e, t) {
        ...
        bindMenuItemShortcuts(e, t) {
            be.call(this, e, "keydown keyup", (i => {
                ...
                if (!s && [" ", "ArrowRight"].includes(i.key)) We.showMenuPanel.call(this, t, !0);
                else {
                    let t;
                    " " !== i.key && ("ArrowDown" === i.key || s && "ArrowRight" === i.key ? (t = e.nextElementSibling, H(t) || (t = e.parentNode.firstElementChild)) : (t = e.previousElementSibling, H(t) || (t = e.parentNode.lastElementChild)), de.call(this, t, !0))
                }
        ...
        createMenuItem({
            ...
            l.innerHTML = s, H(n) && l.appendChild(n), o.appendChild(l), Object.defineProperty(o, "checked", {
                ...
                if (!V(t) || " " === t.key) {
                    ...
                    We.showMenuPanel.call(this, "home", V(t))
                }
            }), i, !1), We.bindMenuItemShortcuts.call(this, o, i), t.appendChild(o)
        },
        formatTime(e = 0, t = !1) {
            if (!O(e)) return e;
            return ze(e, Be(this.duration) > 0, t)
        },
        updateTimeDisplay(e = null, t = 0, i = !1) {
            H(e) && O(t) && (e.innerText = We.formatTime(t, i))
        },
        updateVolume() {
        ...
        updateRangeFill(e) {
            ...
            if (H(t) && "range" === t.getAttribute("type")) {
                ...
                (G.isWebKit || G.isIPadOS) && t.style.setProperty("--value", t.value / t.max * 100 + "%")
            }
        },
        updateSeekTooltip(e) {
            var t, i;
            ...
            c && s.insertAdjacentHTML("afterbegin", `${c.label}<br>`), s.style.left = `${r}%`, F(e) && ["mouseenter", "mouseleave"].includes(e.type) && a("mouseenter" === e.type)
        },
        timeUpdate(e) {
        ...
        updateSetting(e, t, i) {
            ...
            let n = null,
                a = t;
            if ("audioTrack" === e) n = this.audioTrack;
            else if ("captions" === e) n = this.currentTrack;
            else {
        ...
        getLabel(e, t) {
            switch (e) {
                case "audioTrack": {
                    const e = He.get(`audioTrackLabel.${t}`, this.config);
                    return e.length ? e : `${t}`
                }
                case "speed":
        ...
        setAudioTrackMenu(e) {
            if (!H(this.elements.settings.panels.audioTrack)) return;
            const t = "audioTrack",
                i = this.elements.settings.panels.audioTrack.querySelector('[role="menu"]');
            D(e) && (this.options.audioTrack = Ce(e));
            const s = !W(this.options.audioTrack) && this.options.audioTrack.length > 1;
            We.toggleMenuButton.call(this, t, s), se(i), We.checkMenu.call(this), s && (this.options.audioTrack.sort(((e, t) => {
                const i = this.config.audioTrack.options;
                return i.indexOf(e) > i.indexOf(t) ? 1 : -1
            })).forEach((e => {
                We.createMenuItem.call(this, {
                    value: e,
                    list: i,
                    type: t,
                    title: We.getLabel.call(this, "audioTrack", e)
                })
            })), We.updateSetting.call(this, t, i))
        },
        toggleMenu(e) {
            ...
            i.setAttribute("aria-expanded", n), re(t, !n), oe(this.elements.container, this.config.classNames.menu.open, n), n && V(e) ? We.focusFirstMenuItem.call(this, null, !0) : n || s || de.call(this, i, V(e))
        },
        getMenuSize(e) {
        ...
        create(e) {
            ...
            const h = ee("div", ae(this.config.selectors.controls.wrapper));
            this.elements.controls = h;
            const u = {
                class: "plyr__controls__item"
            };
            return Ce(D(this.config.controls) ? this.config.controls : []).forEach((r => {
                if ("restart" === r && h.appendChild(i.call(this, "restart", u)), "rewind" === r && h.appendChild(i.call(this, "rewind", u)), "play" === r && h.appendChild(i.call(this, "play", u)), "fast-forward" === r && h.appendChild(i.call(this, "fast-forward", u)), "progress" === r) {
                    const t = ee("div", {
                    ...
                    this.elements.progress = i, t.appendChild(this.elements.progress), h.appendChild(t)
                }
                if ("current-time" === r && h.appendChild(a.call(this, "currentTime", u)), "duration" === r && h.appendChild(a.call(this, "duration", u)), "mute" === r || "volume" === r) {
                    let {
                        volume: t
                    } = this.elements;
                    if (H(t) && h.contains(t) || (t = ee("div", J({}, u, {
                        class: `${u.class} plyr__volume`.trim()
                    })), this.elements.volume = t, h.appendChild(t)), "mute" === r && t.appendChild(i.call(this, "mute")), "volume" === r && !G.isIos && !G.isIPadOS) {
                        const i = {
                            max: 1,
                            step: .05,
                ...
                if ("captions" === r && h.appendChild(i.call(this, "captions", u)), "settings" === r && !W(this.config.settings)) {
                    const s = ee("div", J({}, u, {
                    ...
                    })), n.appendChild(a), s.appendChild(n), h.appendChild(s), this.elements.settings.popup = n, this.elements.settings.menu = s
                }
                if ("pip" === r && me.pip && h.appendChild(i.call(this, "pip", u)), "airplay" === r && me.airplay && h.appendChild(i.call(this, "airplay", u)), "download" === r) {
                    const e = J({}, u, {
                        element: "a",
                        href: this.download,
                        target: "_blank"
                    ...
                    !z(t) && this.isEmbed && J(e, {
                        icon: `logo-${this.provider}`,
                        label: this.provider
                    }), h.appendChild(i.call(this, "download", e))
                }
                "fullscreen" === r && h.appendChild(i.call(this, "fullscreen", u))
            })), this.config.audioTrack.options.length && c.call(this, this.config.audioTrack.options), this.isHTML5 && r.call(this, _e.getQualityOptions.call(this)), o.call(this), h
        },
        inject() {
            ...
            let i = !0;
            R(this.config.controls) && (this.config.controls = this.config.controls.call(this, t)), this.config.controls || (this.config.controls = []), H(this.config.controls) || $(this.config.controls) ? e = this.config.controls : (e = We.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
            ...
            let s;
            i && $(this.config.controls) && (e = (e => {
                let i = e;
                return Object.entries(t).forEach((([e, t]) => {
                    i = $e(i, `{${e}}`, t)
                })), i
            })(e)), $(this.config.selectors.controls.container) && (s = document.querySelector(this.config.selectors.controls.container)), H(s) || (s = this.elements.container);
            if (s[H(e) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", e), H(this.elements.controls) || We.findElements.call(this), !W(this.elements.buttons)) {
                const e = e => {
                    ...
                    e.setAttribute("aria-pressed", "false"), Object.defineProperty(e, "pressed", {
                        ...
                        get: () => le(e, t),
                        set(i = !1) {
                            oe(e, t, i), e.setAttribute("aria-pressed", i ? "true" : "false")
                        }
                    })
                };
            ...
            if (G.isEdge && Y(s), this.config.tooltips.controls) {
                const {
                    classNames: e,
                    selectors: t
    ...
    function Ye(e) {
        ...
        return _(e) && Object.entries(e).forEach((([e, i]) => {
            t.set(e, i)
        })), t
    }
    const Ge = {
        setup() {
            ...
            var e, t;
            if (H(this.elements.captions) || (this.elements.captions = ee("div", ae(this.config.selectors.captions)), this.elements.captions.setAttribute("dir", "auto"), e = this.elements.captions, t = this.elements.wrapper, H(e) && H(t) && t.parentNode.insertBefore(e, t.nextSibling)), G.isIE && window.URL) {
            ...
            if (j(n) || ({
                ...
                be.call(this, this.media.textTracks, e, Ge.update.bind(this))
            }
        ...
        update() {
            ...
            this.isHTML5 && this.isVideo && e.filter((e => !s.get(e))).forEach((e => {
                ...
                }), "showing" === e.mode && (e.mode = "hidden"), be.call(this, e, "cuechange", (() => Ge.updateCues.call(this)))
            })), (a && this.language !== i || !e.includes(n)) && (Ge.setLanguage.call(this, i), Ge.toggle.call(this, t && a)), this.elements && oe(this.elements.container, this.config.classNames.captions.enabled, !W(e)), D(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && We.setCaptionsMenu.call(this)
        },
        toggle(e, t = !0) {
            if (!this.supported.ui) return;
            const {
        ...
        setLanguage(e, t = !0) {
            if (!$(e)) return void this.debug.warn("Invalid language argument", e);
        ...
        getLabel(e) {
            let t = e;
            return !U(t) && me.textTracks && this.captions.toggled && (t = Ge.getCurrentTrack.call(this)), U(t) ? W(t.label) ? W(t.language) ? He.get("enabled", this.config) : e.language.toUpperCase() : t.label : He.get("disabled", this.config)
        },
        updateCues(e) {
            if (!this.supported.ui) return;
        ...
        Qe = {
            ...
            events: ["ended", "progress", "stalled", "playing", "waiting", "canplay", "canplaythrough", "loadstart", "loadeddata", "loadedmetadata", "timeupdate", "volumechange", "play", "pause", "error", "seeking", "seeked", "emptied", "ratechange", "cuechange", "download", "enterfullscreen", "exitfullscreen", "captionsenabled", "captionsdisabled", "languagechange", "controlshidden", "controlsshown", "ready", "statechange", "qualitychange", "audiotrackchange", "audiotracklistupdate", "audiotracklabelsupdate", "adsloaded", "adscontentpause", "adscontentresume", "adstarted", "adsmidpoint", "adscomplete", "adsallcomplete", "adsimpression", "adsclick"],
            selectors: {
    ...
    class nt {
        constructor(e) {
            t(this, "onChange", (() => {
                ...
                if (e ? this.scrollPosition = {
                    x: window.scrollX ?? 0,
                    y: window.scrollY ?? 0
                } : window.scrollTo(this.scrollPosition.x, this.scrollPosition.y), document.body.style.overflow = e ? "hidden" : "", oe(this.target, this.player.config.classNames.fullscreen.fallback, e), G.isIos) {
                    let t = document.head.querySelector('meta[name="viewport"]');
                    const i = "viewport-fit=cover";
                    t || (t = document.createElement("meta"), t.setAttribute("name", "viewport"));
                    const s = $(t.content) && t.content.includes(i);
                    e ? (this.cleanupViewport = !s, s || (t.content += `,${i}`)) : this.cleanupViewport && (t.content = t.content.split(",").filter((e => e.trim() !== i)).join(","))
                }
                this.onChange()
            })), t(this, "trapFocus", (e => {
                if (G.isIos || G.isIPadOS || !this.active || "Tab" !== e.key) return;
                ...
                if (this.supported) {
                    let e;
                    e = this.forceFallback ? "Fallback (forced)" : nt.nativeSupported ? "Native" : "Fallback", this.player.debug.log(`${e} fullscreen enabled`)
                } else this.player.debug.log("Fullscreen not supported and fallback disabled");
                oe(this.player.elements.container, this.player.config.classNames.fullscreen.enabled, this.supported)
            })), t(this, "enter", (() => {
                this.supported && (G.isIos && this.player.config.fullscreen.iosNative ? this.player.isVimeo ? this.player.embed.requestFullscreen() : this.target.webkitEnterFullscreen() : !nt.nativeSupported || this.forceFallback ? this.toggleFallback(!0) : this.prefix ? W(this.prefix) || this.target[`${this.prefix}Request${this.property}`]() : this.target.requestFullscreen({
                    navigationUI: "hide"
                }))
            })), t(this, "exit", (() => {
                if (this.supported)
                    if (G.isIos && this.player.config.fullscreen.iosNative) this.player.isVimeo ? this.player.embed.exitFullscreen() : this.target.webkitEnterFullscreen(), Se(this.player.play());
                    else if (!nt.nativeSupported || this.forceFallback) this.toggleFallback(!1);
                    else if (this.prefix) {
                        if (!W(this.prefix)) {
        ...
        get useNative() {
            return nt.nativeSupported && !this.forceFallback
        }
        static get prefix() {
        ...
        get supported() {
            return [this.player.config.fullscreen.enabled, this.player.isVideo, nt.nativeSupported || this.player.config.fullscreen.fallback, !this.player.isYouTube || nt.nativeSupported || !G.isIos || this.player.config.playsinline && !this.player.config.fullscreen.iosNative].every(Boolean)
        }
        get active() {
            if (!this.supported) return !1;
            if (!nt.nativeSupported || this.forceFallback) return le(this.target, this.player.config.classNames.fullscreen.fallback);
            const e = this.prefix ? this.target.getRootNode()[`${this.prefix}${this.property}Element`] : this.target.getRootNode().fullscreenElement;
            return e && e.shadowRoot ? e === this.target.getRootNode().host : e === this.target
        }
        get target() {
            return G.isIos && this.player.config.fullscreen.iosNative ? this.player.media : this.player.elements.fullscreen ?? this.player.elements.container
        }
    }
    ...
    const rt = {
        ...
        migrateStyles() {
            Object.values({
                ...this.media.style
            }).filter((e => !W(e) && $(e) && e.startsWith("--plyr"))).forEach((e => {
    ...
    class ot {
        constructor(e) {
            t(this, "firstTouch", (() => {
                ...
                t.config.keyboard.global && fe.call(t, window, "keydown keyup", this.handleKey, e, !1), fe.call(t, document.body, "click", this.toggleMenu, e), ve.call(t, document.body, "touchstart", this.firstTouch)
            })), t(this, "container", (() => {
                const {
                    player: e
                } = this, {
                ...
                if (be.call(e, e.media, "timeupdate seeking seeked", (t => We.timeUpdate.call(e, t))), be.call(e, e.media, "durationchange loadeddata loadedmetadata", (t => We.durationUpdate.call(e, t))), be.call(e, e.media, "ended", (() => {
                    e.isHTML5 && e.isVideo && e.config.resetOnEnd && (e.restart(), e.pause())
                })), be.call(e, e.media, "progress playing seeking seeked", (t => We.updateProgress.call(e, t))), be.call(e, e.media, "volumechange", (t => We.updateVolume.call(e, t))), be.call(e, e.media, "playing play pause ended emptied timeupdate", (t => rt.checkPlaying.call(e, t))), be.call(e, e.media, "waiting canplay seeked playing", (t => rt.checkLoading.call(e, t))), e.supported.ui && e.config.clickToPlay && !e.isAudio) {
                ...
                })), be.call(e, e.media, "audiotrackchange", (t => {
                    We.updateSetting.call(e, "audioTrack", null, t.detail.audioTrack)
                })), be.call(e, e.media, "audiotracklistupdate", (t => {
                    We.setAudioTrackMenu.call(e, t.detail.list)
                })), be.call(e, e.media, "audiotracklabelsupdate", (t => {
                    e.config.i18n.audioTrackMPDLabel = t.detail.list, We.setAudioTrackMenu.call(e, e.options.audioTrack)
                }));
                ...
                if (t.buttons.play && Array.from(t.buttons.play).forEach((t => {
                    ...
                    [" ", "Enter"].includes(t.key) && ("Enter" !== t.key ? (t.preventDefault(), t.stopPropagation(), We.toggleMenu.call(e, t)) : We.focusFirstMenuItem.call(e, null, !0))
                ...
                })), G.isWebKit && Array.from(he.call(e, 'input[type="range"]')).forEach((t => {
        ...
        handleKey(e) {
            ...
            if (c) {
                ...
                if (H(n)) {
                    ...
                    if (" " === e.key && ce(n, 'button, [role^="menuitem"]')) return
                }
    ...
    const ut = {
        setup() {
            const e = this;
            oe(e.elements.wrapper, e.config.classNames.embed, !0), e.options.speed = e.config.speed.options, Le.call(e), _(window.Vimeo) ? ut.ready.call(e) : ct(e.config.urls.vimeo.sdk).then((() => {
                ut.ready.call(e)
            })).catch((t => {
        ...
        ready() {
            ...
            const l = Ye({
                ...
                c = W(h = a) ? null : O(Number(h)) ? h : h.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : h;
            var h;
            const u = ee("iframe"),
                d = Oe(e.config.urls.vimeo.iframe, c, l);
            if (u.setAttribute("src", d), u.setAttribute("allowfullscreen", ""), u.setAttribute("allow", ["autoplay", "fullscreen", "picture-in-picture", "encrypted-media", "accelerometer", "gyroscope"].join("; ")), W(s) || u.setAttribute("referrerPolicy", s), i || !t.customControls) u.setAttribute("data-poster", e.poster), e.media = ne(u, e.media);
            else {
                const t = ee("div", {
            ...
            t.customControls || Ve(Oe(e.config.urls.vimeo.api, d)).then((t => {
            ...
            Object.defineProperty(e.media, "loop", {
                ...
                const [i, s] = t;
                e.embed.ratio = Ie(i, s), Le.call(this)
                ...
                e.media.textTracks = t, Ge.setup.call(e)
    ...
    const mt = {
        setup() {
            if (oe(this.elements.wrapper, this.config.classNames.embed, !0), _(window.YT) && R(window.YT.Player)) mt.ready.call(this);
            else {
        ...
        getTitle(e) {
            Ve(Oe(this.config.urls.youtube.api, e)).then((e => {
                if (_(e)) {
                    const {
                        title: t,
                        height: i,
                    ...
                    this.config.title = t, rt.setTitle.call(this), this.embed.ratio = Ie(s, i)
                }
                Le.call(this)
            })).catch((() => {
                Le.call(this)
        ...
        gt = {
            setup() {
                ...
                }), X(this.media, this.elements.wrapper), this.elements.poster = ee("div", {
                    class: this.config.classNames.poster
                }), this.elements.wrapper.appendChild(this.elements.poster)), this.isHTML5 ? _e.setup.call(this) : this.isYouTube ? mt.setup.call(this) : this.isVimeo && ut.setup.call(this)) : this.debug.warn("No media element found!")
            }
        };
    class ft {
        constructor(e) {
            t(this, "load", (() => {
                this.enabled && (_(window.google) && _(window.google.ima) ? this.ready() : ct(this.player.config.urls.googleIMA.sdk).then((() => {
                    this.ready()
                })).catch((() => {
            ...
            })), t(this, "on", ((e, t) => (D(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this))), t(this, "startSafetyTimer", ((e, t) => {
        ...
        get enabled() {
            ...
            return this.player.isHTML5 && this.player.isVideo && e.enabled && (!W(e.publisherId) || z(e.tagUrl))
        }
        get tagUrl() {
            const {
                config: e
        ...
        constructor(e) {
            t(this, "load", (() => {
                ...
                if (R(t)) t((e => {
                    ...
                    const e = ($(t) ? [t] : t).map((e => this.getThumbnail(e)));
                ...
                this.elements.thumb.time = ee("span", {}, "00:00"), e.appendChild(this.elements.thumb.time), this.elements.thumb.imageContainer.appendChild(e), H(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container), this.elements.scrubbing.container = ee("div", {
    ...
    const kt = {
        ...
        change(e) {
            Q(e, "sources.length") ? (_e.cancelRequests.call(this), this.destroy.call(this, (() => {
                ...
                Object.assign(this, {
                    ...
                    media: ee(a, r)
                }), this.elements.container.appendChild(this.media), j(e.autoplay) && (this.config.autoplay = e.autoplay), this.isHTML5 && (this.config.crossorigin && this.media.setAttribute("crossorigin", ""), this.config.autoplay && this.media.setAttribute("autoplay", ""), W(e.poster) || (this.poster = e.poster), this.config.loop.active && this.media.setAttribute("loop", ""), this.config.muted && this.media.setAttribute("muted", ""), this.config.playsinline && this.media.setAttribute("playsinline", "")), rt.addStyleHook.call(this), this.isHTML5 && kt.insertElements.call(this, "source", t), this.config.title = e.title, gt.setup.call(this), this.isHTML5 && Object.keys(e).includes("tracks") && kt.insertElements.call(this, "track", e.tracks), (this.isHTML5 || this.isEmbed && !this.supported.ui) && rt.build.call(this), this.isHTML5 && this.media.load(), W(e.previewThumbnails) || (Object.assign(this.config.previewThumbnails, e.previewThumbnails), this.previewThumbnails && this.previewThumbnails.loaded && (this.previewThumbnails.destroy(), this.previewThumbnails = null), this.config.previewThumbnails.enabled && (this.previewThumbnails = new wt(this))), this.fullscreen.update()
            }), !0)) : this.debug.warn("Invalid source format")
        }
    };
    class Tt {
        constructor(e, i) {
            if (t(this, "play", (() => R(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then((() => this.ads.play())).catch((() => Se(this.media.play()))), this.media.play()) : null)), t(this, "pause", (() => this.playing && R(this.media.pause) ? this.media.pause() : null)), t(this, "togglePlay", (e => (j(e) ? e : !this.playing) ? this.play() : this.pause())), t(this, "stop", (() => {
                this.isHTML5 ? (this.pause(), this.restart()) : R(this.media.stop) && this.media.stop()
            })), t(this, "restart", (() => {
                this.currentTime = 0
            })), t(this, "rewind", (e => {
                this.currentTime -= O(e) ? e : this.config.seekTime
            })), t(this, "forward", (e => {
                this.currentTime += O(e) ? e : this.config.seekTime
            })), t(this, "increaseVolume", (e => {
                const t = this.media.muted ? 0 : this.volume;
                this.volume = t + (O(e) ? e : 0)
                ...
                const i = () => {
                    document.body.style.overflow = "", this.embed = null, t ? (Object.keys(this.elements).length && (ie(this.elements.buttons.play), ie(this.elements.captions), ie(this.elements.controls), ie(this.elements.wrapper), this.elements.buttons.play = null, this.elements.captions = null, this.elements.controls = null, this.elements.wrapper = null), R(e) && e()) : (ke.call(this), _e.cancelRequests.call(this), ne(this.elements.original, this.elements.container), we.call(this, this.elements.original, "destroyed", !0), R(e) && e.call(this.elements.original), this.ready = !1, setTimeout((() => {
            ...
            })), t(this, "supports", (e => me.mime.call(this, e))), this.timers = {}, this.ready = !1, this.loading = !1, this.failed = !1, this.touch = me.touch, this.media = e, $(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || q(this.media) || D(this.media)) && (this.media = this.media[0]), this.config = J({}, Qe, Tt.defaults, i || {}, (() => {
                try {
                ...
                speed: [],
                quality: []
            }, this.debug = new st(this.config.debug), this.debug.log("Config", this.config), this.debug.log("Support", me), I(this.media) || !H(this.media)) return void this.debug.error("Setup failed: no suitable element passed");
            ...
            switch (n) {
                case "div":
                    ...
                    if (W(this.provider) || !Object.values(Ze).includes(this.provider)) return void this.debug.error("Setup failed: Invalid provider");
                    this.type = tt;
                    break;
                case "video":
                case "audio":
            ...
            this.supported = me.check(this.type, this.provider), this.supported.api ? (this.eventListeners = [], this.listeners = new ot(this), this.storage = new Fe(this), this.media.plyr = this, H(this.elements.container) || (this.elements.container = ee("div"), X(this.media, this.elements.container)), rt.migrateStyles.call(this), rt.addStyleHook.call(this), gt.setup.call(this), this.config.debug && be.call(this, this.elements.container, this.config.events.join(" "), (e => {
        ...
        get buffered() {
            ...
            return O(e) ? e : e && e.length && this.duration > 0 ? e.end(0) / this.duration : 0
        }
        get seeking() {
        ...
        set volume(e) {
            let t = e;
            $(t) && (t = Number(t)), O(t) || (t = this.storage.get("volume")), O(t) || ({
                volume: t
        ...
        set speed(e) {
            let t = null;
            O(e) && (t = e), O(t) || (t = this.storage.get("speed")), O(t) || (t = this.config.speed.selected);
            const {
                minimumSpeed: i,
                maximumSpeed: s
            } = this;
        ...
        set audioTrack(e) {
            const t = this.config.audioTrack,
                i = this.options.audioTrack;
            if (!i.length) return;
            const s = [!W(e) && e, this.storage.get("audioTrack"), t.selected, t.default].find((e => e));
            i.includes(s) ? (t.selected = s, this.media.audioTrack = s, R(this.config.audioTrack.onChange) && this.config.audioTrack.onChange(e), we.call(this, this.media, "audiotrackchange", !1, {
                audioTrack: e
            })) : this.debug.warn(`Unsupported audioTrack option: ${s}`)
        }
        get audioTrack() {
        ...
        set quality(e) {
            ...
            if (!i.length) return;
            let s = [!W(e) && Number(e), this.storage.get("quality"), t.selected, t.default].find(O),
                n = !0;
            if (!i.includes(s)) {
                const e = Ae(i, s);
        ...
        set download(e) {
            z(e) && (this.config.urls.download = e, We.setDownloadUrl.call(this))
        }
        set poster(e) {
        ...
        set ratio(e) {
            this.isVideo ? $(e) && Me(e) ? (this.config.ratio = Ne(e), Le.call(this)) : this.debug.error(`Invalid aspect ratio specified (${e})`) : this.debug.warn("Aspect ratio can only be set for video")
        }
        set autoplay(e) {
        ...
        set currentTrack(e) {
            Ge.set.call(this, e, !1), Ge.setup.call(this)
        }
        get currentTrack() {
            const {
                toggled: e,
        ...
        set pip(e) {
            ...
            R(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? Je : Xe), R(this.media.requestPictureInPicture) && (!this.pip && t ? this.media.requestPictureInPicture() : this.pip && !t && document.exitPictureInPicture())
        }
        get pip() {
            return me.pip ? W(this.media.webkitPresentationMode) ? this.media === document.pictureInPictureElement : this.media.webkitPresentationMode === Je : null
        }
        ...
        static setup(e, t = {}) {
            let i = null;
            return $(e) ? i = Array.from(document.querySelectorAll(e)) : q(e) ? i = Array.from(e) : D(e) && (i = e.filter(H)), W(i) ? null : i.map((e => new Tt(e, t)))
        }
    }
    var St;
    return Tt.defaults = (St = Qe, JSON.parse(JSON.stringify(St))), Tt
}));
